...
CREATE TABLE `crewinator.event_invites` (
  ...
  CONSTRAINT `event_users_event` FOREIGN KEY (`event_id`) REFERENCES `events` (`event_id`),
  CONSTRAINT `event_users_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
CREATE TABLE `crewinator.games` (
  ...
  PRIMARY KEY (`game_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3291 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
